          ...
          <?php endif; wp_reset_postdata(); endforeach; endif; ?>
			...
			<div class="p-hikaku__foot">
				...
				<p style="margin-top: 10px">
					<small class="small">
            ※1 お申込時間や審査によりご希望に添えない場合がございます。<br>※2 メールアドレス登録とWeb明細利用の登録が必要です。<br>※3  最短即日審査：年末年始を除く。17時までのお申込みに限ります。申込み状況等により、翌営業日以降の審査となる場合がございます。<br>※4 最短即日※システムメンテナンス時間はご利用いただけません。振込実施のタイミングはご利用の金融機関により異なります。
					<?php 
						$isMoneyCard = false;
            $isLinePocket = false;
						if($rank_objects) {
