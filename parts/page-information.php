      ...
      <?php
        ...
        $information_array= [
          1 => [
            ...
            'text' => '銀行系カードローンには、銀行が直接提供するものや、銀行グループ傘下の消費者金融が提供するタイプがあります。<br>これらのうち銀行が提供するカードローンは、<span class="red">一般的な消費者金融と比べて上限金利が低めに設定されている場合が多く、利息の負担を抑えやすいのが特長</span>です！長期の借入を検討している方に向いています。',
          ],
          2 => [
