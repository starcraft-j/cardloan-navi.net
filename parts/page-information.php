      ...
      <?php
        ...
        $information_array= [
          1 => [
            ...
            'text' => '銀行系カードローンには、銀行が直接提供するものや、銀行グループ傘下の消費者金融が提供するタイプがあります。<br>これらのうち銀行が提供するカードローンは、<span class="red">一般的な消費者金融と比べて上限金利が低めに設定されている場合が多</span>く、<span class="red bold">利息の負担を抑えやすいのが特長</span>です！長期の借入を検討している方に向いています。',
          ],
          2 => [
            'text' => '利用するカードローンによって、借入可能な限度額は異なります。<span class="red bold">銀行系カードローンなら、最大800万円以上の借入ができる可能性もあります！</span><br>まとまった金額を借入したいと考えている方には、銀行系カードローンの利用が便利でオススメです！',
          ],
          3 => [
            'text' => '銀行系カードローンというと、窓口での手続きが大変そう・・・とイメージする方もいますが、<span class="red bold">手続きはネットからOKで24時間いつでも申込可能です！</span><br>金利も低く安心感のある銀行系カードローンは、多くの方に利用されています！',
          ],
        ]
      ?>
...
',
          ...
          3 => [
            'text' => 'メガバンクや地方銀行が提供する銀行系カードローンなら直接店舗で相談できたり、大手なので安心して借りられます。<br>銀行や提携ATMで借入・返済できて、<span class="red bold">郵送物なしやキャッシュカードでそのままお金が借りられる銀行もあるので、</span>プライバシーへの配慮がなされているのも嬉しいポイントです！',
          ],
        ]
      ?>
